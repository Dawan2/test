...
/* ================= 套件 19:剧本拆集双端单源(wf-core split* + 服务端/CLI/浏览器接入,G-04) =================
...
const SUITES = { 'agent-ops': agentOpsTests, experts: expertsTests, produce: produceTests, commands: commandsTests, store: storeTests, 'sb-gen': sbGenTests, pipeline: pipelineTests, 'sb-views': sbViewsTests, 'sb-io': sbIoTests, understanding: understandingTests, billing: billingTests, domain: domainTests, bus: busTests, issues: issuesTests, plans: plansTests, continuity: continuityTests, release: releaseTests, contract: contractTests, tasks: tasksTests, split: splitTests };
(async () => {
