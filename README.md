...
浏览器 SPA(hash 路由,30+ 个 js 模块)
   ...
   │                 校验型扩展点 CHECKS 已落地十条:剧本面 SK-07/08/09(开篇钩子锚定 / 打脸四步
