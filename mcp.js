...
const RESOURCES = [
  ...
  { uri: 'hujing://memory', name: '协作记忆', description: '用户偏好与已确认修改决定 + 审片/发布闭环回流的可判定结论(state.agentMemory,按板块沉淀;对话层与 /api/wf/* 工作流同算法召回),同 cli memory list', mimeType: 'application/json' },
];
