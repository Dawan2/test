...
浏览器 SPA(hash 路由,30+ 个 js 模块)
   ...
   │                 校验型扩展点 CHECKS 已落地 SK-12 分镜引用主体完备性(判定现取 Domain,
   │                 经就绪检查回执 result.checks 双端消费,只报不拦、零 LLM 零计费)
