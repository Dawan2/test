...
(function (root, factory) {
  ...
  const REG = [
    /* ---- 贯通层 ---- */
    {
      ...
      kb: ['WR_CORE', 'WR_STRUCTURE', 'WR_HOOKS', 'WR_REVERSALS', 'WR_FACESLAP', 'WR_PAYOFF', 'WR_DIALOGUE',
        'WR_CHARACTER', 'WR_PITFALLS', 'DR_MISE', 'DR_SHOT', 'DR_AXIS', 'DR_RHYTHM', 'GC_FORMULA', 'GC_RULES',
        'GC_MULTI', 'GC_REFS'],
    ...
    /* ---- 剧本 ---- */
    {
      ...
      kb: ['WR_HOOKS', 'WR_CORE'], experts: ['ex_hook'], gaps: ['G-13', 'G-04'],
    },
    {
      id: 'script.hookStrength', sk: 'SK-07', name: '开篇钩子强度校验', stage: 'script', wave: 'W4',
      kinds: ['check'], pending: ['check'], kb: ['WR_HOOKS'], experts: ['ex_hook'], gaps: ['G-10', 'G-04', 'S-01'],
    },
    {
      id: 'script.faceslapFour', sk: 'SK-08', name: '打脸四步完备性校验', stage: 'script', wave: 'W4',
      kinds: ['check'], pending: ['check'], kb: ['WR_FACESLAP', 'WR_REVERSALS'], experts: ['ex_pleasure'],
      gaps: ['G-10', 'G-04', 'S-01'],
    },
    {
      ...
      kb: ['WR_DIALOGUE', 'WR_CHARACTER'], prompts: ['sb.system'], cmds: ['episode.generateStoryboard'],
    ...
    /* ---- 主体 ---- */
    {
      ...
      kb: ['GC_REFS'], settings: ['tplImage'], cmds: ['episode.preflight', 'shot.generateVideo'],
      gaps: ['G-06', 'G-13'],
    },
    {
    ...
    /* ---- 分集 ---- */
    {
      ...
      kinds: ['inject', 'check'], pending: ['check'], kb: ['WR_STRUCTURE'], experts: ['ex_structure'],
      gaps: ['G-13', 'G-04', 'S-01'],
      note: 'kb 顺序与节拍板拆解注入点一致;拆集补服务端属 W3,覆盖校验属 W4',
    },
    {
      id: 'eps.payoffPoint', sk: 'SK-15', name: '付费卡点位置校验', stage: 'eps', wave: 'W4',
      kinds: ['check'], pending: ['check'], kb: ['WR_PAYOFF'], experts: ['ex_pleasure'], gaps: ['G-10', 'G-04', 'S-01'],
    },
    {
      ...
      steps: [
        ...
        { cmd: 'episode.generateStoryboard', args: {}, note: '智能分镜:按理解口径拆镜;拆集与主体提取待 G-04 补命令后前置进本编排' },
      ],
    },
    /* ---- 分镜 ---- */
    {
      id: 'shots.shotLanguage', sk: 'SK-17', name: '镜头语言词表归一与注入', stage: 'shots', wave: 'W2',
      kinds: ['inject'], kb: ['DR_SHOT', 'DR_AXIS'], prompts: ['sb.system'],
    ...
    },
    {
      ...
      kb: ['DR_SHOT', 'DR_AXIS'], prompts: ['sb.reviewUser', 'review.system'], cmds: ['episode.smartReview'],
    ...
    },
    {
      ...
      kb: ['GC_FORMULA', 'GC_RULES', 'GC_MULTI'], prompts: ['sb.system'], settings: ['tplVideo'],
    ...
    },
    {
      ...
      kinds: ['check'], pending: ['check'], kb: ['DR_RHYTHM', 'GC_RULES'], cmds: ['episode.generateStoryboard'],
      gaps: ['S-04'],
    ...
    /* ---- 生成 ---- */
    {
      ...
      kinds: ['inject'], pending: ['inject'], kb: ['GC_FORMULA'], settings: ['tplVideo'],
    ...
    },
    {
      ...
      kinds: ['check'], pending: ['check'], kb: ['GC_RULES'],
    ...
    /* ---- 成片 ---- */
    {
      ...
      kinds: ['inject'], kb: ['DR_RHYTHM'], prompts: ['review.finalSystem'], cmds: ['episode.compose'],
