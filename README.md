...
- **命令元数据双端单源(二十二轮·二批 §2.1)**:`js/cmd-registry.js` UMD 注册 8 条领域命令元数据(name/label/risk/needs/desc/args),commands.js REG 默认值与 `Commands.list()`、cli.js help/EXEC 词表、mcp.js 工具描述全部由注册表生成(此前三处手抄);契约测试断言三端词表集合相等 + cli help 实跑含全部命令。
